...
from ncbi2ontogene3_generator import process_file, transform_input
...
class RecordSet(object):
	...
	if self.options == "default":
        ...
        for row, new_term in transform_input(processed_input, RecType.og_mapping, unified_build=True):
            self.stats["ids"] += 1
            if new_term:
                self.stats["term"] += 1
            yield row
